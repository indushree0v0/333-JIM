...
const projects = [
  ...
  {
    title: 'Cognitive Firewall System',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, idx) => (
            <ScrollReveal key={idx} animation="fade-up" delay={(idx % 3) * 150} className="h-full">
              <Card
                className="group p-0 overflow-hidden border-slate-800 bg-slate-950/40 backdrop-blur-xl relative flex flex-col min-h-[460px] hover:border-primary-500/40 hover:-translate-y-1.5 transition-all duration-300 h-full"
              >
